...
$(function () {
    ...
    "data": [
    {
    "name": "Innovation<br><small class='text-muted'><i>Budget: 5,000<i></small>",
	...
	"comments": "This section allows for adding feedback and notes related to employee performance on the HRMS scorecard at Mbarara University (MUST).",
	...
	{
	"name": "Performance plan<br><small class='text-muted'><i>Budget: 5,000<i></small>",
	...
	{
	"name": "Upgrade to windows 11<br><small class='text-muted'><i>Budget: 2,000<i></small>",
	...
	{
	"name": "Publishing<br><small class='text-muted'><i>Budget: 4,000<i></small>",
