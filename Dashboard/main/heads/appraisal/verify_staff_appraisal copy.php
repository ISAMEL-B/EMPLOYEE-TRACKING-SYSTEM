                    ...
                    <ul class="nav nav-tabs" id="tableTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="academic-tab" data-bs-toggle="tab"
                                data-bs-target="#academic" type="button" role="tab">Academic Activities</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="activity-types-tab" data-bs-toggle="tab"
                                data-bs-target="#activity-types" type="button" role="tab">Activity Types</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="community-tab" data-bs-toggle="tab" data-bs-target="#community"
                                type="button" role="tab">Community Service</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="degrees-tab" data-bs-toggle="tab" data-bs-target="#degrees"
                                type="button" role="tab">Degrees</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="grants-tab" data-bs-toggle="tab" data-bs-target="#grants"
                                type="button" role="tab">Grants</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="innovations-tab" data-bs-toggle="tab"
                                data-bs-target="#innovations" type="button" role="tab">Innovations</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="professional-tab" data-bs-toggle="tab"
                                data-bs-target="#professional" type="button" role="tab">Professional Bodies</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="publications-tab" data-bs-toggle="tab"
                                data-bs-target="#publications" type="button" role="tab">Publications</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="service-tab" data-bs-toggle="tab" data-bs-target="#service"
                                type="button" role="tab">Service</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="staff-tab" data-bs-toggle="tab" data-bs-target="#staff"
                                type="button" role="tab">Staff</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="supervision-tab" data-bs-toggle="tab"
                                data-bs-target="#supervision" type="button" role="tab">Supervision</button>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" class="record-checkbox"
                                                value="<?php echo $row['activity_id']; ?>"></td> <!-- NEW -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['community_service_id']; ?>"
                                                    data-table="communityservice">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-approve approve-record"
                                                    data-id="<?php echo $row['community_service_id']; ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['degree_id']; ?>" data-table="degrees">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-approve approve-record"
                                                    data-id="<?php echo $row['degree_id']; ?>" data-table="degrees">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['grant_id']; ?>" data-table="grants">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-approve approve-record"
                                                    data-id="<?php echo $row['grant_id']; ?>" data-table="grants">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['innovation_id']; ?>"
                                                    data-table="innovations">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-approve approve-record"
                                                    data-id="<?php echo $row['innovation_id']; ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['professional_body_id']; ?>"
                                                    data-table="professionalbodies">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-approve approve-record"
                                                    data-id="<?php echo $row['professional_body_id']; ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['publication_id']; ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['service_id']; ?>" data-table="service">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-approve approve-record"
                                                    data-id="<?php echo $row['service_id']; ?>" data-table="service">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['staff_id']; ?>" data-table="staff">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-approve approve-record"
                                                    data-id="<?php echo $row['staff_id']; ?>" data-table="staff">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-view view-record"
                                                    data-id="<?php echo $row['supervision_id']; ?>"
