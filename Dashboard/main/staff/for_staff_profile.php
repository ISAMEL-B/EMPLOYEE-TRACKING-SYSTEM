...
if (!empty($user_data['staff_id'])) {
    $staff_query = $conn->prepare("SELECT s.*, d.department_name, r.role_name, f.faculty_name
                                 ...
                                 WHERE s.staff_id = ?");
    $staff_query->bind_param("i", $user_data['staff_id']);
    $staff_query->execute();
    ...
    $performance_query->bind_param("iiiiiiii", $user_data['staff_id'], $user_data['staff_id'], $user_data['staff_id'], 
                                 $user_data['staff_id'], $user_data['staff_id'], $user_data['staff_id'], 
                                 $user_data['staff_id'], $user_data['staff_id']);
    ...
    $grants_query->bind_param("i", $user_data['staff_id']);
    ...
    $degrees_query->bind_param("i", $user_data['staff_id']);
    ...
    $publications_query->bind_param("i", $user_data['staff_id']);
    ...
    $bodies_query->bind_param("i", $user_data['staff_id']);
    ...
    $supervision_query->bind_param("i", $user_data['staff_id']);
    ...
    $community_query->bind_param("i", $user_data['staff_id']);
