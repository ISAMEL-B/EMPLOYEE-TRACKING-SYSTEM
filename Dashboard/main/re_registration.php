            ...
            <?php if ($is_hrm): ?>
                <div class="employee-select-container mb-4">
                    ...
                    <div class="input-group">
                        <select id="employeeSelect" class="form-select" onchange="location.href='?staff_id=' + this.value;">
                            <option value="">Search for an employee</option>
                            <?php foreach ($employees as $employee): ?>
                                <option value="<?= $employee['staff_id'] ?>" <?= isset($_GET['staff_id']) && $_GET['staff_id'] == $employee['staff_id'] ? 'selected' : '' ?>>
                                    <?= htmlspecialchars($employee['employee_id'] . ' - ' . $employee['first_name'] . ' ' . $employee['last_name']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        <?php if ($staff): ?>
                            <button class="btn btn-outline-secondary" type="button" id="resetSelection" onclick="location.href='<?= basename($_SERVER['PHP_SELF']) ?>'">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" value="<?= htmlspecialchars($staff['email']) ?>" readonly>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone_number" name="phone_number"
                                    placeholder="required format 0701234567" pattern="^07[0-9]{8}$"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" class="form-control" id="personal_email" name="personal_email"
                                    value="<?= htmlspecialchars($staff['personal_email']) ?>">
                            </div>
