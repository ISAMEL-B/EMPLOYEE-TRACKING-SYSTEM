    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                ...
                MUST HRM Expert Scorecard System
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="bi bi-clipboard-data"></i> Scorecards</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="bi bi-journal-bookmark"></i> Research</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="bi bi-people"></i> Community Service</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="sidebar col-md-3 col-lg-2 d-md-block">
        <div class="position-sticky pt-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="bi bi-person-lines-fill"></i> Staff Directory
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="bi bi-building"></i> Faculty Overview
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="bi bi-mortarboard"></i> Academic Performance
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="bi bi-search"></i> Research & Grants
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="bi bi-heart"></i> Community Service
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
            ...
            <div class="mt-4 p-3 highlight-yellow">
                ...
                <button class="btn btn-sm btn-must w-100 mb-2">
                    <i class="bi bi-person-plus"></i> Add Staff Member
                </button>
                <button class="btn btn-sm btn-outline-must w-100 mb-2">
                    <i class="bi bi-file-earmark-medical"></i> Generate Scorecard
                </button>
                <button class="btn btn-sm btn-outline-must w-100">
                    <i class="bi bi-calendar-event"></i> Schedule Review
                </button>
            </div>
        </div>
    </div>
