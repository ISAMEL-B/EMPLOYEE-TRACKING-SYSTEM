...
// Load the JSON data
$json_file_path = 'criteria_data.json'; // Change this to your actual path
...
<head>
    ...
    <style>
        ...
        h3 {
            ...
            box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.5); /* Increased shadow intensity */
            color: black;
            padding: 10px;
            text-align: center;
            margin-bottom: 10px;
        ...
        button {
            ...
            display: block; /* Makes the button take up full width of the parent block */
        }
...
<body>
    ...
    <a href="../upload.php">GoToUploadCsv</a> ||
    <a href="../modify/column.php">GoToModifyCsvColumns</a>
