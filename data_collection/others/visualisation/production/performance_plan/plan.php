...
<head>
    ...
    <style>
        ...
        .name-section {
            margin-bottom: 10px; /* Add some space below the name section */
        }
        .TableInputs{
            width: 90%; 
            padding: 10px;
...
<div class="form-container">
    ...
    <form action="process_form.php" method="post" onsubmit="validateForm(event)">
        ...
        <div class="name-section">
            ...
            <input type="text" id="username" name="username" required style="width: 90%; padding: 10px; margin-top: 5px;">
        </div>
            ...
            <tr>
                <td><input type="text" name="teaching_outputs[]" class="TableInputs"></td>
                <td><input type="text" name="teaching_indicators[]" class="TableInputs"></td>
                <td><input type="text" name="teaching_targets[]" class="TableInputs"></td>
            </tr>
            ...
            <tr>
                <td><input type="text" name="research_outputs[]" class="TableInputs"></td>
                <td><input type="text" name="research_indicators[]" class="TableInputs"></td>
                <td><input type="text" name="research_targets[]" class="TableInputs"></td>
            </tr>
            ...
            <tr>
                <td><input type="text" name="community_outputs[]" class="TableInputs"></td>
                <td><input type="text" name="community_indicators[]" class="TableInputs"></td>
                <td><input type="text" name="community_targets[]" class="TableInputs"></td>
            </tr>
