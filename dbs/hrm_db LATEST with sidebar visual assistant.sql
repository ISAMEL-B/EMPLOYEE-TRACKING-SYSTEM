...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2025 at 09:13 PM
...
(8, 'Alice', 'Williams', 'Non Clinical', 2, 2, 10, 89),
(9, 'James', 'Anderson', 'Clinical', 1, 3, 11, 86),
(10, 'Linda', 'Taylor', 'Non Clinical', 3, 4, 7, 78),
(12, 'Jane', 'isa', 'Researcher', 3, 2, 3, 78),
(13, 'Ali', 'Khan', 'Assistant Lecturer', 4, 1, 2, 67),
(14, 'Maria', 'Nabwire', 'Lecturer', 2, 3, 7, 92),
(15, 'Peter', 'Okello', 'Senior Lecturer', 1, 2, 10, 95),
(16, 'Sarah', 'Kimani', 'Assistant Lecturer', 4, 4, 1, 60),
(17, 'David', 'Tumusiime', 'Lecturer', 2, 3, 6, 88),
(18, 'Grace', 'Achan', 'Research Fellow', 3, 1, 4, 73),
(19, 'Michael', 'Mwangi', 'Senior Researcher', 5, 2, 9, 90),
(20, 'Linda', 'Namatovu', 'Lecturer', 2, 4, 5, 82);
...
INSERT INTO `users` (`user_id`, `staff_id`, `employee_id`, `email`, `password`, `role`, `first_name`, `last_name`, `phone_number`, `personal_email`, `date_created`, `photo_path`, `reset_token`, `reset_token_expiry`) VALUES
